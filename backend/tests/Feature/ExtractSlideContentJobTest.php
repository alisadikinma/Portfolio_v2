 ...
 * success persists `extracted` + advances captured → extracted + dispatches
 * ResearchRepurposeClaims; failure → failed + Telegram reply. Idempotent.
 */
class ExtractSlideContentJobTest extends TestCase
{
    ...
    public function test_success_persists_extracted_and_dispatches_research(): void
    {
