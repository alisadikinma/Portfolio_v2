 ...
 *
 * NOTE: this seeder intentionally does NOT set `client_photo` or
 * `linkedin_url` — those are admin-managed via /admin/testimonials.
 * Re-running the seeder will not clobber operator edits to those fields.
 */
