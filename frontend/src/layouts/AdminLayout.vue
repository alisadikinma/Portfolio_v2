<template>
  <div class="dark min-h-screen bg-neutral-100 dark:bg-neutral-900">
    <div class="flex">
      <!-- Sidebar -->
      <aside
        ...
        <div class="h-full flex flex-col">
          ...
          <nav class="flex-1 overflow-y-auto p-4">
            <div class="space-y-1">
              ...
              <!-- LinkedIn section — blog→LinkedIn publishing admin -->
