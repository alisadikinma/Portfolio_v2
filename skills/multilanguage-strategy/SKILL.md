---
name: multilanguage-strategy
description: "EN/ID bilingual content strategy: subdirectory URL structure, hreflang implementation, content adaptation vs translation, write-first language strategy, translation workflow, per-locale SEO, GEO for multi-language, SPA solutions. Use when creating bilingual content."
---

# Multi-Language Content Strategy (EN/ID)
