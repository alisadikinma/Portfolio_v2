...
├── LinkedInGenerationService.php # SSH-invokes plugin `/linkedin-gen` CLI, parses stdout JSON, advances FSM (sync)
...
**Still deferred:**
- Carousel PDF composition via TCPDF (text posts work end-to-end now; carousel routes to manual_review since publish returns 503)
